 ...
 * @returns {bluebird}
 */
exports.loadSchemaObject = function(jsonFilePath, schemaPath, validationLevel) {
    ...
    return this.loadJSON(jsonFilePath)
        ...
        function(jsonObj) {
            // Verify the schema file exists
            return exports.fileStatus(__dirname + '/' + schemaPath)
                .then(function(schemaStatus) {
                    // The schema needs to be a file
                    if(schemaStatus === 'file') {
                        // Create the validator
                        var validate = validator(schemaPath);
                        // Validate the JSON data
                        validate(jsonObj);
                    ...
                    console.log('Schema not found: ' + __dirname + '/' + schemaPath)
                    return false;
                }
            )
        },
 ...
 * @returns {bluebird}
 */
exports.loadObject = function(jsonObj, schemaPath, validationLevel) {
